    ...
    public function run(): void
    {
        Page::updateOrCreate(
            ...
            [
                ...
                'body'    => '<p>Ulverston Mobile began as a small workshop with one mandate — treat every device, every customer, and every repair with the precision of a flagship store. Years later, trading as Elitefone Services Ltd, that conviction still shapes everything we do.</p><p>We service authentic devices from the brands that define modern technology, with certified, manufacturer-grade parts. Same-day repairs, transparent pricing, and a 12-month warranty are standard, not exceptions.</p><p>Behind every transaction is a team of certified technicians who treat your device the way they treat their own. That commitment is why customers from across Cumbria trust us with everything from cracked screens to deep, board-level repairs.</p>',
                'meta_title'       => 'About Ulverston Mobile — Precision repair and authentic devices',
                'meta_description' => 'Learn about Ulverston Mobile (Elitefone Services Ltd), the destination for precision phone repair and authentic devices, trusted across Cumbria.',
                'is_published'     => true,
            ],
        );
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'meta_title'       => 'Contact Ulverston Mobile',
                'meta_description' => 'Get in touch with the Ulverston Mobile team for sales, support, or repair inquiries.',
                'is_published'     => true,
            ],
        );
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'meta_title'       => 'Discounts at Ulverston Mobile',
